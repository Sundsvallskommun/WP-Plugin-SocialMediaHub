...
class SK_Service_Feeder{
  ...
  public function importer(){
    ...
    update_option('sksmh_latest_import', date( 'Y-m-d H:i:s' ) );
  ...
  private function curl_processor( $url, $header = false ){
    ...
    public function get_feeds( $feed, $service ){
      ...
      //echo count( $data ) . ' ' . $data[$key]['user'] . ' ' . $service . '<br>';

      //util::debug( count( $data ), $service );
